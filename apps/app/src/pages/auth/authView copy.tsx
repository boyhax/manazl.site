...
import { IonContent, isPlatform, useIonToast } from "@ionic/react";
...
export default function () {
  ...
  const handleGoogleSignIn = async () => {
    ...
    console.log('isPlatformhybrid :>> ', isPlatform('hybrid'));
    setIsLoading(true)
    if (isPlatform('hybrid')) {
      try {
        ...
        await SocialLogin.initialize({
          google: {
            webClientId: import.meta.env.VITE_APP_GOOGLE_AUTH_ID,
          },
        });
        ...
        toast({ duration: 2000, message: "Google sign in failed" });
      }
    } else {
      //web google auth
    }
  ...
  return (
    <IonContent>
      <Card className="w-[350px] border-none sm:border bg-background mx-auto">
        ...
        <CardContent>
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="grid w-full grid-cols-3">
              ...
              <TabsTrigger value="login">{t("Email")}</TabsTrigger>
