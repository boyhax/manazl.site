...
export default function HostReservationCardsView({ data: reservations }) {


  return (
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 h-full last:mb-20  pb-20 ">
      ...
      <div className="flex flex-col space-y-2">
        ...
        <div className="flex items-center justify-between">
          <div className={"flex items-center "}>
            ...
            <Button onClick={() => {
              getChatId(reservation.variants.listing_id).then(({ id }) => navigate('/chat/' + id))
